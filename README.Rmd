...
A perpendicular truncation distance, $w$, of `r w=0.03` and a maximum forward distance, $y_{max}$, of `r ystart=0.05` were used in our primate data analyses.  For line transect notation see Fig. 1 in the paper.
...
A perpendicular truncation distance, $w$, of `r wd=0.15` and a maximum forward distance, $y_{max}$, of `r ystartd=0.55` were used in our primate data analyses.

```{r,dolphinPlot, eval=FALSE}
data(dolphin.dat)
xd=dolphin.dat$x
yd=dolphin.dat$y
